...
if(isset($_POST['submit'])){
    ...
    $insertSql = "INSERT INTO technews (technewstitle,technewsauthor,technewsdate,technewsimages,technewscontent) " ; 
...
<a style="color:#FFFFFF;" href="../posts/technews.php"><button type="button" style="float:right; padding:2px 15px 2px 15px; font-size:15px;" class="btn btn-primary">Go Back Post</button></a>
   <span class="label label-info">Your are in New TechNews Post Page </span>
   <form action="" class="form-group" method="post" enctype="multipart/form-data" name="addPosts" onsubmit="return(validate());">
    <table class="table table-striped table-hover table-bordered">
       <th style="text-align:center;"><h3>Create New TechNews Post</h3></th>
